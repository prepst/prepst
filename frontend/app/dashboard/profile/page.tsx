...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      <div
        className="w-full space-y-8 origin-top scale-[0.9]"
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  ...
                  <div className="w-full bg-secondary/50 h-1.5 rounded-full mt-1 overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${Math.min(
                          100,
                          ((stats?.current_math_score || 0) / 800) * 100
                        )}%`,
                      }}
                    />
                  </div>
                  ...
                  <div className="w-full bg-secondary/50 h-1.5 rounded-full mt-1 overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${Math.min(
                          100,
                          ((stats?.current_rw_score || 0) / 800) * 100
                        )}%`,
                      }}
                    />
                  </div>
                ...
                <div className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-2xl p-5 flex flex-col gap-2 shadow-sm hover:bg-accent/5 transition-colors">
                  ...
                  <span className="text-xs text-muted-foreground">
                    {stats?.total_practice_sessions || 0} sessions completed
                  </span>
                </div>
