...
export interface paths {
    ...
    "/api/analytics/users/me/study-time": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Get User Study Time
         * @description Get user's total study time from practice sessions and mock exams.
         *
         ...
         */
        get: operations["get_user_study_time_api_analytics_users_me_study_time_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/manim/generate": {
        ...
        /**
         * Generate Video
         * @description Generate a Manim video from a natural language math question.
         ...
         */
        post: operations["generate_video_api_manim_generate_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/manim/videos": {
        ...
        /**
         * List User Videos
         * @description List videos generated by the current user.
         *
         *     Args:
         *         user_id: User ID from authentication token
         *         db: Database client
         ...
         */
        get: operations["list_user_videos_api_manim_videos_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/manim/videos/{filename}": {
        ...
        /**
         * Get Video
         * @description Serve generated Manim video files.
         *
         *     Args:
         ...
         *         Video file
         */
        get: operations["get_video_api_manim_videos__filename__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        /**
         * StudyTimeResponse
         * @description Response model for study time
         */
        StudyTimeResponse: {
            /** Total Minutes */
...
export interface operations {
    ...
    get_user_study_time_api_analytics_users_me_study_time_get: {
        parameters: {
            query?: {
                /** @description Number of days to look back */
                days_back?: number;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["StudyTimeResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    generate_video_api_manim_generate_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    list_user_videos_api_manim_videos_get: {
        parameters: {
            query?: {
                limit?: number;
            };
    ...
    get_video_api_manim_videos__filename__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
