      ...
      >
        <div className="flex flex-col items-center justify-center h-full min-h-[250px] gap-4">
          ...
          <p className="text-muted-foreground max-w-md mx-auto">
            You've crushed all your scheduled sessions. Take a break or start a
            custom practice to keep the streak going.
          </p>
          <Button
          ...
          <div className="space-y-4 flex-1">
            ...
            <div>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl">
                {session.description ||
                  `Master ${session.topic_name} with ${session.num_questions} targeted practice questions designed to boost your score.`}
              </p>
            </div>
          </div>
